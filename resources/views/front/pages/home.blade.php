...
<div class="style-full-width-layout page-layout theme25 clearfix ">
    ...
    <a class="float-button" target="_blank" href="https://wa.me/{{ config('app.phone_number')}}?text= Hola! te saluda Liseth tu asesora comercial en linea, por favor cuentame que producto le interesa.">
